...
summary: Setup an Ansible development environment in Visual Studio Code
date: 2023-06-29
lastmod: 2025-08-19
tags:
  - ansible
...
{{< figure src="vsc_remote_connect.png" alt="Code remote connect" caption="VSCode Remote connect" >}}
...
{{< figure src="vsc_extension_install.png" alt="Extension install in WSL" caption="VSCode WSL extension install" >}}
...
{{< figure src="ansible_filetype.png" alt="Ansible Filetype" caption="Ansible filetype in Code" >}}

You should now see autocompletion working.

{{< figure src="ansible_intellisense.png" alt="Ansible Intellisense in VSCode" caption="Ansible Intellisense" >}}
...
[Deep Dive on Ansible VS Code Extension](https://www.ansible.com/blog/deep-dive-on-ansible-vscode-extension)
